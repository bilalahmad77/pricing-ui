...
export default function Pricing()
{
  return(
    <Box mx='6' as ='section'>
    <Box maxW='994px' margin='auto' mt='-40' borderRadius='xl' overflow='hidden' textAlign='center' box-shadow='0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)'>
        <Flex direction={['column','column','row']}>
            ...
            <Button colorScheme='purple' size='lg' w={['auto','282px','282px']} mt='6'>Get Started</Button>
            </Box>
