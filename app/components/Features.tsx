import { Stack,HStack,Icon,StackProps,Text,Box } from "@chakra-ui/react";
import {
    MoneyBackGuranteeIcon,HassleFreeIcon,MonthlySubscriptionIcon
} from '../icons/Icons' 
...
export default function Features(){
    return(
        ...
        <Stack px='12' direction={['column','column','row']} spacing={['6','6','5']}>
            ...
            <Feature icon={MonthlySubscriptionIcon}>24/7 support and consulting</Feature>
        </Stack>
        </Box>
